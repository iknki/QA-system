...
import user_pic from '@/assets/user.jpeg'
import robot_pic from '@/assets/robot.png'
  ...
  <div :class="['message-row', role === 'user' ? 'right' : 'left']">
    ...
    <div class="row">
      ...
      <div class="avatar-wrapper">
        <el-avatar v-if="role === 'user'" :src="user_pic" class="avatar" shape="circle"/>
        <el-avatar v-else :src="robot_pic" class="avatar" shape="circle" />
      </div>
      <!-- 发送的消息或者回复的消息 -->
      <div class="message">
        ...
        <MdPreview
            ...
            :style="{
            backgroundColor: role === 'user' ? 'rgb(231, 248, 255)' : 'white'
          }"
        ></MdPreview>
        <!-- 如果消息的内容为空则显示加载动画 -->
